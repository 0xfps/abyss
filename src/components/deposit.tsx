...
export function Deposit() {
    ...
    return <div className="w-full p-2">
        ...
        <div className="p-2 bg-body h-[120px] mt-2">
            ...
            <div className="h-[60%] flex">
                <input className="w-full flex justify-start items-center text-3xl tracking-tight" style={{ textTransform: "none" }} value={createRandomString()} />
            </div>

            <div className="h-[20%]">
                <span className="cursor-pointer hover:opacity-80">[Auto generate]</span>
                <span className="cursor-pointer hover:opacity-80 ml-2">[Paste]</span>
        ...
        <div className="mt-4">
            <button className="bg-btn-success py-4 w-full text-lg hover:bg-btn-success-hover cursor-pointer" onClick={() => setModal("DEPOSIT-PREVIEW")}>
                Preview deposit
            </button>
        </div>
    </div>
